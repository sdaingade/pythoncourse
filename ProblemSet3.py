...
def problem3_1(txtfilename):
    ...
    print()
    print()
    print("There are", letterCount , "letters in the file.")
...
def problem3_4(mon, day, year):
    ...
    month = months[mon]
    #print("problem3_4(\"" + mon + "\"," + str(day) +", " + str(year) + ")")
...
def problem3_7(csv_pricefile, flower):
    ...
    for entry in csv.reader(inFile):
        flowers[entry[0]] = entry[1]

    #print("problem3_7(\"" + csv_pricefile + "\",\"" + flower + "\")")
